...
* EDD License
*****************************************************************************************/
update_option('perfmatters_edd_license_key', 'GenesisforWP'); 
...
define('PERFMATTERS_VERSION', '1.5.5');
...
include plugin_dir_path(__FILE__) . '/inc/functions_script_manager.php';
