...
class MainPro
{
	...
	public function init()
	{
		...
		add_filter('wpacu_pro_get_asset_file_size', array($this, 'getAssetFileSize'), 10, 2);
                ...
                <tr class="form-field">
                    ...
                    <td data-wpacu-taxonomy="<?php echo $tag->taxonomy; ?>">
                        ...
                        if ($targetUri = assetCleanUpHasNoLoadMatches($targetUrl)) {
	                        ...
	                        <?php
	                        $msg =__('This taxonomy\'s URI <em>'.$targetUri.'</em> is matched by one of the RegEx rules you have in <strong>"Settings"</strong> -&gt; <strong>"Plugin Usage Preferences"</strong> -&gt; <strong>"Do not load the plugin on certain pages"</strong>, thus Asset CleanUp Pro is not loaded on that page and no CSS/JS are to be managed. If you wish to view the CSS/JS manager, please remove the matching RegEx rule and reload this page.', 'wp-asset-clean-up');
	                        ?>
