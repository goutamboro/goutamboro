...
if ( ! function_exists( 'wpacu_wp_set_current_user' ) ) :
	 ...
	 *
	 * @since 2.0.3
	 * @global WP_User $wpacu_current_user The current user object which holds the user data.
	 *
...
if ( ! function_exists( 'wpacu_wp_get_current_user' ) ) :
	 ...
	 * @global WP_User $wpacu_current_user Checks if the current user is set.
	 *
...
// Only load the WordPress functions below if the user is logged-in
$wpacu_current_user = wpacu_wp_get_current_user();
